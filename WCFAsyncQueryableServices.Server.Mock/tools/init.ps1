...
{
	throw "You must install WCF Async Queryable Services vsix. See WAQS documentation on http://msmvps.com/blogs/matthieu/archive/2013/12/13/how-to-use-waqs.aspx"
}
