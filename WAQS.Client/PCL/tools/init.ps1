...
foreach ($_ in Get-Module | ?{$_.Name -eq 'WAQSFunctionsClientPCL'})
{
    Remove-Module 'WAQSFunctionsClientPCL'
    break
}    

Import-Module (Join-Path $toolsPath WAQSFunctionsClientPCL.psm1)
